...
class IntegerDivisionLogicTest extends IntegerDivisionLogic {

	@Test
	void getDigitByPosition_shouldReturnDigitInAssignedPosition() {
		assertEquals(9, getDigitByPosition(78945, 2));
		assertEquals(7, getDigitByPosition(78945, 0));
		assertEquals(5, getDigitByPosition(78945, 10));
	}
	
	@Test
	void getNumberPlacedBetweenZeroPositionAndDigitPosition_shouldReturnNumberBetweenZeroPositionAndAssignedPosition() {
		assertEquals(789, getNumberPlacedBetweenZeroPositionAndDigitPosition(78945, 2));
		assertEquals(1, getNumberPlacedBetweenZeroPositionAndDigitPosition(1, 0));
		assertEquals(1, getNumberPlacedBetweenZeroPositionAndDigitPosition(1, 0));
	}
	...
	void getPieceOfDividendWhichIsBiggerThenDivisorStartingFromZeroPosition_shouldReturnNumberStartingFromZeroPositionWhichIsBiggerOrEqualToSpecifiedNumber() {
		assertEquals(78, getPieceOfDividendWhichIsBiggerThenDivisorStartingFromZeroPosition(78945, 70));
		assertEquals(789, getPieceOfDividendWhichIsBiggerThenDivisorStartingFromZeroPosition(78945, 80));
		assertEquals(7894, getPieceOfDividendWhichIsBiggerThenDivisorStartingFromZeroPosition(78945, 800));
		assertEquals(7894, getPieceOfDividendWhichIsBiggerThenDivisorStartingFromZeroPosition(78945, 7000));
	}
	...
	void solvingTheProblemAndConvertingItToArray_shouldReturnCorrectMainsolvingTheProblemAndConvertingItToArray() {
		...
		ArrayList<int[]> problemSolutionConvertedToStringActual = new ArrayList<int[]>(solvingTheProblemAndConvertingItToArray(78945, 4));

		int j = 0;

		for (int[] n : problemSolutionConvertedToStringActual) {
			for (int i : n) {
				assertEquals(problemSolutionConvertedToStringTheoretical[j], i);
				j++;
			}
		}
	}
	...
	void solvingTheProblemAndConvertingItToArray_offsetsShouldBeCalculateCorrectly_whenAllNumbersShouldBePlacedWithOffset() {
		...
		ArrayList<int[]> problemSolutionConvertedToStringActual = new ArrayList<int[]>(solvingTheProblemAndConvertingItToArray(100000, 90));
	...
	void solvingTheProblemAndConvertingItToArray_lastOffsetShouldBeCalculateCorrectly_whenProblemContainsFourLinesAndRemainderEqualsToZero() {
		...
		ArrayList<int[]> problemSolutionConvertedToStringActual = new ArrayList<int[]>(solvingTheProblemAndConvertingItToArray(1000, 10));
	...
	void solvingTheProblemAndConvertingItToArray_lastOffsetShouldBeCalculateCorrectly_whenProblemContainsFourLinesAndRemainderDoesNotEqualsToZero() {
		...
		ArrayList<int[]> problemSolutionConvertedToStringActual = new ArrayList<int[]>(solvingTheProblemAndConvertingItToArray(1001, 10));
	...
	void solvingTheProblemAndConvertingItToArray_lastOffsetShouldBeCalculateCorrectly_whenProblemContainsMoreThenFourLinesAndRemainderEqualsToZero() {
		...
		ArrayList<int[]> problemSolutionConvertedToStringActual = new ArrayList<int[]>(solvingTheProblemAndConvertingItToArray(10000, 4));
	...
	void solvingTheProblemAndConvertingItToArray_lastOffsetShouldBeCalculateCorrectly_whenProblemContainsMoreThenFourLinesAndRemainderDoesNotEqualsToZero() {
		...
		ArrayList<int[]> problemSolutionConvertedToStringActual = new ArrayList<int[]>(solvingTheProblemAndConvertingItToArray(10001, 4));
	...
	void solvingTheProblemAndConvertingItToArray_lastOffsetShouldBeCalculateCorrectly_whenProblemIsToDivideEqualNumbers() {
		...
		ArrayList<int[]> problemSolutionConvertedToStringActual = new ArrayList<int[]>(solvingTheProblemAndConvertingItToArray(245, 245));
	...
	void solvingTheProblemAndConvertingItToArray_lastOffsetShouldBeCalculateCorrectly_whenSolutionOfProblemContainsMoreThenFourLinesAndReminderIsZero() {
		...
		ArrayList<int[]> problemSolutionConvertedToStringActual = new ArrayList<int[]>(solvingTheProblemAndConvertingItToArray(2435, 5));
